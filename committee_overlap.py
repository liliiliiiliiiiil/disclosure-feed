...
SIC_SECTORS = (
    ...
    (("10", "12", "14"), "mining"),
    (("13", "29", "46"), "energy"),
    # tech 는 좁게 잡는다. 35 대분류에는 컴퓨터 말고 펌프·엔진·농기계가,
    # 38 에는 의료기기가, 36 에는 엘리베이터가 섞여 있다. 넓게 잡았더니
    # 실측에서 펌프 제조사(3561)와 수술기기 회사(3842)가 과학기술위 관할로
    # 잡혔다. 소위원회 관할이라 볼 수 있는 대역만 남긴다.
    (("357", "3661", "3663", "3669", "367", "737"), "tech"),
    (("384",), "health"),                        # 의료기기는 보건 관할
    (("48",), "telecom"),
    (("49",), "utilities"),
